...
class TransformerLayer(nn.Module):
    def forward_with_attention(self, x, y: TN = None, mask: TN = None, alpha: TN = None):
...
class CrossTransformerLayer(TransformerLayer):
    def forward_attention(self, x, y: TN = None, mask: TN = None, alpha: TN = None):
...
class CombTransformer(nn.Module):
    ...
    def __init__(self, dim_self: int, num_heads: int, num_layers: int, dim_ref: int,
        ...
        self.layers = nn.ModuleList([PixelformerLayer(dim_self, dim_ref, num_heads, mlp_ratio, act=act,
                                                           norm_layer=norm_layer) for _ in range(num_layers)])